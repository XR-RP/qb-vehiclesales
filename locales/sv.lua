local Translations = {
    error = {
        ...
        not_in_veh = 'Du är inte i ett fordon!',
        not_for_sale = 'Detta fordon är INTE till salu!',
    },
    menu = {
        view_contract = 'Se kontrakt',
        view_contract_int = '[E] Se kontrakt',
        sell_vehicle = 'Sälj fordon',
        sell_vehicle_help = 'Sälj fordon till medborgare!',
        sell_back = 'Sälj tillbaka bilen!',
        sell_back_help = 'Sälj din bil direkt tillbaka till bilhandlaren för ett reducerat pris!',
        interaction = '[E] Sälj fordon',
    },
    success = {
    ...
    info = {
        ...
        cancel_sale = '[~r~G~w~] - Avbryt försäljning',
